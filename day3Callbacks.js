...
var ingredientsArray = ['quinoa', 'banana', 'zucchini', 'guacamole'];
...
//  function invokeOnEach(array, aFunction){
//     for(var i =0;i<array.length;i++){
//       funcInvoker(aFunction,array[i]);
//     }   
//  }
// // Example:
...
//   function various(){
//     console.log("Im here five seconds later");
//   }
//   call5SecondsLater(various);
...
//             return afunction();
//         } else {
//             return 'You have already called this function';
//         }
//       }
//    return something;
// }
...
//     console.log('all of your monies!!');
// }

// var tryingToGetMonies = onlyOnce(emptyBankAccount);
// tryingToGetMonies();
...
function bye (){
    console.log("I have already said hello. So Bye");
}

function invokedOnce(callback1,callback2){
    var status = true;
    function something(){
        if(status === true){
            status = false;
...
var greeting = invokedOnce(hello,bye);
greeting();
greeting();
