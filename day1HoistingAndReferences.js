...
console.log('mySeconVar will equal undefined', mySecondVar);
var mySecondVar;

mySecondVar = 1;
// 2. What is the value of mySecondVar now?
console.log('I expect mySeconVar to be 1',mySecondVar);
console.log('mySecond');
mySecondVar = 2;
// 3. And what is it now?
console.log('I expect mySecondVar to equal 2',mySecondVar);
...
console.log('I would expect bikeCopy to be {color:pink}',bikeCopy);

bikeCopy.brand = 'Public';
// What would we expect bikeCopy.brand to be?
console.log('I would expect bikeCopy to be {color:pink,brand:Public}',bikeCopy);
// What would we expect myBike.brand to be? Can you explain why to your pair?
console.log('I would expect bikeCopy to be Public',bikeCopy.brand);

var sparklyBikeMechanic = function(inputBike) {
  inputBike.sparklerCount = 2; 
};
//NOTICE SINCE WE ARE NOT RETURNING ANYTHING THERE IS NO WAY TO ACCESS THE ACTUAL VARIABLE IF WE DID SOMETHING LIKE THIS
// var returnedFunction = sparklyBikeMechanic(bikeCopy) ==> result will be undefined. (BECAUSE WE DID NOT RETURN FROM THE ACUTUAL OBJECT FROM THE FUNCTION. WE JUST MODIFIED IT INSIDE THE FUNCTION) 

console.log('This is the function. I expect to be undefined',sparklyBikeMechanic(bikeCopy)); // if we call this all the objects will have the property along with the value; If we don't call this the objects will result in undefined
...
console.log('I would expect myBike.sparklerCount to be {color:pink,brand:public,sparklerCount:2}',myBike);
...
console.log("I expect myBike.carbonFiber to be everthing because we modified the home memory as well",myBike.carbonFiber); 
...
console.log('I am looking for returnedBike',returnedBike);

returnedBike.color = 'black';
// What do we expect bikeCopy.color to be now?
console.log('I expect bikeCopy.color to be black',bikeCopy.color);

//NOTE IF YOU CALL A FUNCTION USING CONSOLE.LOG. THAT FUNCTION WILL MODIFY ALL THE CODES WRITTEN AFTER IT.
...
console.log("We did not link the object to the variable.Ex: line 80 : So the result would be undefined", noBikeHere);
  ...
  // What does that mean in our example? 
    ...
    // In this case, it will evaluate forgetfulMechanic(bikeCopy);
...
// What do we expect notABike to be? 
  console.log('I expect notABike to return forgotten',notABike);
  // Test this out!
...
console.log('I expect shiningBike to be to have all parameters that bikeCopy has',shiningBike);
...
console.log('I expect numVar to equal 8',numVar);
// What do we expect num2 to be?
console.log("I expect num2 to equal 8",num2);
num2 = num2 + 10;
// What do we expect num2 to be?
console.log("I expect num2 to equal 18",num2);
