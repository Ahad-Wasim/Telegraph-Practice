...
var vegetarianCorner = function() {
  ...
  console.log('I expect the chef to be Amanda',chef);
  ...
  console.log('I expect address to be : 1600 Shattuck Avenue',address);
};
vegetarianCorner();

// Now that we're back in the global scope (we're no longer inside the function body), what is chef?
//console.log("I expect chef to be: undefined",chef); Not defined in global scope so it kills the page
  // Explain why to your pair. 
// What is address in this scope? Why?
  console.log('I expect address to be : 1600 Shattuck Avenue',address);
//address is the global scope
...
var bbqMeatCooker = function() {
  ...
  console.log('This bbqMeatCooker\'s  chef is Raka:',chef);
  ...
  console.log('The address will be the backy yard one:',address);
    // Explain why to your pair! 
  ...
  console.log('the address is 1610 shattuck Ave:',address);
};
bbqMeatCooker();
...
console.log('The address is 1600 shattuck Ave:', address);
...
// What are the values of chef and address here?
  // Explain why to your pair!
  console.log('the chef is Michael', chef);
  console.log('the address is 1517 Shattuck Ave', address);
...
vegetarianCorner = function() {
  ...
  console.log('the address is now 1517 shattuck avenue',address);
    // Why?
};
vegetarianCorner();
...
bbqMeatCooker = function() {
  ...
  address = '1610 Shattuck Ave';
  // What is the value of address here? 
  console.log('The value of address is 1610 Shattuck Ave:',address);
    // Why?
  // What is the value of chef here?
  console.log('The chef is Raka',chef);
    // Why?
